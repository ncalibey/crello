    ...
    return (
      <div>
        ...
        <div className="content">
          <label>Title</label>
          <textarea name="name" style={{marginBottom: '12px'}} defaultValue='Card Title'></textarea>
          <label>Keep…</label>
          ...
          <div>
            <div className="button-link setting list">
              ...
              <select>
                ...
                <option value="2" defaultValue>Intermediate (current)</option>
            ...
            <div className="button-link setting position">
              ...
              <select>
                <option value="top" defaultValue>1 (current)</option>
